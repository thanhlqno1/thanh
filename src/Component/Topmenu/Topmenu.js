    ...
    return (
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top" style={{height: '100px' , background: 'white'}}>>
              ...
              <a className="navbar-brand" href="/home" style={{position: 'static', right: '974px', fontSize: 'x-large', color: 'black'}}>CES Music App</a>
              ...
              <div className="collapse navbar-collapse" id="navbarResponsive">
                <ul className="navbar-nav ml-auto">
                  ...
                  <a className="nav-link"  href="/signup" style={{position: 'relative', right: '-180px', color: 'black'}}>Sign Up</a>
                  </li>
                  
                  <li className="nav-item">
                  <a className="nav-link" href="/login" style={{position: 'relative', right: '-180px', color: 'black'}}>Log In</a>
                  </li>
                </ul>
              </div>
